          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join With Us Today & Build World-changing products
              </h2>
              <p>
                Sign up for free without any credit card requirement and come one step closer to bringing the idea of readily-available API key acccessible and available to all.
              </p>
            </motion.div>
            <motion.div
              variants={{
